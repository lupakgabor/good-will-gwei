            ...
            >
                ...
                >
                    ...
                    <Form.Item
                        ...
                        label="Private key"
                        rules={[
                            {message: 'Private key needs to start 0x and has to be 66 characters', min: 66, max: 66}
                        ]}
                    >
                        <Input/>

                    </Form.Item>
                    <p className='text-red-500 text-center'>Never give your private key to anyone! Use predefined ones
                        instead!</p>
                </Form>
                <div className='grid'>
                    {TEST_PRIVATE_KEY.map((key) => (
                        <Button
                            key={key}
                            className='my-1'
                            onClick={() => form.setFieldValue('privateKey', key)}>
