...
export const Home = () => {
	return (
		<BasePage>
			<Typography>
				<Typography.Title className="text-center !mx-10 !mb-10">
					Empower Charities with the Power of Web3
				</Typography.Title>
			...
			<Flex justify="space-around">
				<Link to="/json-rpc" className="w-1/4">
					<Card hoverable cover={<img alt="json-rpc" src={jsonRPC} className="h-96" />}>
						<Card.Meta
							title="JSON-RPC"
				...
				<Link to="/alchemy" className="w-1/4">
					<Card hoverable cover={<img alt="aclhemy" src={alchemy} className="h-96" />}>
						<Card.Meta
							title="Alchemy"
				...
				<Link to="/wagmi" className="w-1/4">
					<Card hoverable cover={<img alt="wagmi" src={wagmi} className="h-96" />}>
						<Card.Meta
							title="WAGMI"
