	...
	return (
		<Card
			...
			actions={[
				...
				/>,
				<WithdrawButton onConfirm={() => props.onWithdraw()} disabled={!isCharityManager} />,
				<RemoveButton onConfirm={() => props.onRemove(props.charity.charityAddress)} disabled={!isManager} />,
			]}
		>
